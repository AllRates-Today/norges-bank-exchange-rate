// Norges Bank exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/norges';
...
/** Latest rate for one pair, e.g. getRate('USD', 'NOK', { apiKey }). */
